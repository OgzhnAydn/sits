                ...
                {a.kampanya && a.kampanya.domainSayisi > 1 && (
                  <div className="mt-3 rounded-2xl border border-error/20 bg-error/5 p-3">
                    ...
                    <div className="mt-1.5 grid grid-cols-2 gap-x-3 gap-y-1 text-[11px] text-on-surface-variant">
                      {a.kampanya.ipler.length > 0 && <div className="min-w-0 break-all">Ortak IP: <b className="text-on-surface">{a.kampanya.ipler.join(", ")}</b></div>}
                      {a.kampanya.asnler.length > 0 && <div className="min-w-0 break-all">ASN: <b className="text-on-surface">{a.kampanya.asnler.join(", ")}</b></div>}
                      {a.kampanya.iletisimKanallari.length > 0 && <div className="col-span-2 min-w-0 break-all">Dolandırıcı kanalı: <b className="text-error">{a.kampanya.iletisimKanallari.join(", ")}</b></div>}
